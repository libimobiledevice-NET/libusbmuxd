...
int usbmuxd_set_socket_type(enum usbmuxd_socket_type value)
{
#if defined(WIN32) || defined(__CYGWIN__)
...
int usbmuxd_get_socket_type(enum usbmuxd_socket_type* value)
{
	*value = socket_type;
	return 0;
}

int usbmuxd_set_tcp_endpoint(const char* host, uint16_t port)
{
...
int usbmuxd_get_tcp_endpoint(char** host, uint16_t* port)
{
